...
Hay muchos tipos diferentes de eventos de Nostr. La lista más actualizada de los tipos de eventos más comunes siempre se puede encontrar en el [repositorio de Nostr NIPs](https://github.com/nostr-protocol/nips).
