...
El mejor recurso que hemos encontrado para explorar y evaluar la velocidad de los relés conocidos es el [sitio de Nostr.watch](https://nostr.watch?utm_source=nostr.how&ref=nostr.how).
...
Para la mayoría de las personas, no vale la pena el inconveniente. Dicho esto, si tienes conocimientos técnicos y deseas asegurarte de que tu discurso sea absolutamente inmune a la censura, o si deseas ejecutar un relé privado para un pequeño grupo, entonces puedes y debes ejecutar tu propio relé. Esto garantiza que siempre tengas una copia de todas tus publicaciones e interacciones en Nostr. Hay muchas implementaciones de relés escritas en distintos lenguajes de programación o añadidas a servicios populares como StartOS o Alby Hub.
