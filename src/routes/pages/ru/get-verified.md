...
description: Как верифицировать учётную запись Nostr, получить подтверждающий значок и легко делиться своим профилем.
---

## [§](#что-вы-узнаете) Что вы узнаете из этого руководства
...
![Значок верификации](/images/snort-verified.webp)
...
## [§](#бесплатная-верификация) Бесплатная верификация через сторонний сервис
...
## [§](#платная-верификация) Платная верификация через сторонний сервис
...
## [§](#самостоятельная-верификация) Самостоятельная верификация
