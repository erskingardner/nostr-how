...
یک لیست بروز از رله های پولی با جزئیات هزینه و قیمت و شخص اداره کننده آنها را میتوانید اینجا بیابید [صرافی رله](https://relay.exchange?utm_source=nostr.how&ref=nostr.how)

### کجا می توانم لیستی از همه رله ها پیدا کنم؟

بهترین منبعی که برای مرور و کاوش و ارزیابی سرعت رله های شناخته شده پیدا کرده ایم [Nostr.watch سایت](https://legacy.nostr.watch/relays/find?utm_source=nostr.how&ref=nostr.how) است.
