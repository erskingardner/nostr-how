...
Переконайтеся, що ви зберігаєте свій приватний ключ у безпечному місці, наприклад, у менеджері паролів (нам подобається [1Password](https://1password.com?utm_source=nostr.how&ref=nostr.how)) або у розширенні для браузера, такому як [Alby](https://getalby.com/?utm_source=nostr.how&ref=nostr.how#alby-extension).
...
[Alby](https://getalby.com?utm_source=nostr.how&ref=nostr.how) - популярне розширення для підпису та bitcoin lightning гаманець, який має вбудовану підтримку Nostr. Це чудовий варіант для нових користувачів.
