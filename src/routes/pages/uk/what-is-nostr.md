...
Оскільки облікові записи Nostr базуються на [криптографії з відкритим ключем](https://uk.wikipedia.org/wiki/Криптографія_з_відкритим_ключем?utm_source=nostr.how&ref=nostr.how), легко перевірити, що повідомлення дійсно було надіслано користувачем.
