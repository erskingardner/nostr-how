...
La meilleure ressource que nous ayons trouvée pour parcourir et évaluer la vitesse des relais connus est le [site Nostr.watch](https://nostr.watch?utm_source=nostr.how&ref=nostr.how).
...
Pour la plupart des gens, non, cela ne vaut pas la peine. Cela dit, si vous êtes technique et que vous voulez vous assurer que votre discours n'est absolument pas censurable ou que vous voulez gérer un relais privé pour un petit groupe, alors vous pouvez et devriez gérer votre propre relais. Cela vous permettra d'avoir toujours une copie de tous vos messages et interactions sur Nostr. Il existe de nombreuses implémentations de relais écrites dans différents langages de programmation ou ajoutées à des services populaires comme StartOS ou Alby Hub.
