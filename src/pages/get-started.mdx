...
This guide will help you understand the basics of Nostr and get you all set up and ready to use Nostr with a new account. We’ll cover how to create a new lightning wallet, create an account, and sign into a client safely. {{ className: 'lead' }}
...
- [Iris](/guides/iris) (Web)
- [Damus](/guides/damus) (iOS)
- [Amethyst](/guides/amethyst) (Android)
...
- [What are Relays and how do they work?](/relays)
- [Learn more about NIPs and the development of the protocol](/the-protocol/nips)
